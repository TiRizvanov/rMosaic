...
**rMosaic** provides R bindings for [Mosaic 0.21.1](https://idl.cs.washington.edu/mosaic/), a framework for declarative, interactive, and scalable visualizations. This vignette demonstrates basic usage with a working example.
...
Check the [Mosaic documentation](https://idl.cs.washington.edu/mosaic/) for all available marks and interactions.
